    ...
    >
      <div className="flex justify-between items-center py-4 px-6 md:px-10">
        ...
        <div className="hidden md:flex">
          <button
            className="px-6 py-2 rounded-full font-semibold transition-all duration-300 bg-red-600 hover:scale-105"
            style={{
              backgroundImage:
                "",
              color: "",
      ...
      {isOpen && (
        ...
        >
          ...
          <button
            onClick={toggleMenu}
            className="px-6 py-2 rounded-full bg-red-600 font-semibold transition-all duration-300 hover:scale-105"
            style={{
              backgroundImage:
                "",
              color: "",
