  ...
  const data = [
    {
      ...
      image:
        "/i3.webp",
      icon: <Dumbbell className="text-red-600 w-6 h-6" />,
    },
    {
      id: 2,
      ...
      image:
        "/i4.webp",
      icon: <Flame className="text-red-600 w-6 h-6" />,
    },
    {
      id: 3,
      ...
      image:
        "/i5.webp",
      icon: <Target className="text-red-600 w-6 h-6" />,
    },
    {
      id: 4,
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center order-1 md:order-1">
          <img
            ...
            className="rounded-xl w-full max-w-md h-[400px] object-cover border border-red-600/40 shadow-[0_0_25px_#E1912F40] transition-all duration-700 ease-in-out"
          />
          ...
          {data.map((item, index) => (
            <div
              ...
              className={`flex items-start gap-5 p-5 rounded-xl cursor-pointer transition-all duration-500 ${
                currentIndex === index
                  ? "bg-red-600/10 shadow-[0_0_15px_#E1912F50]"
                  : "bg-transparent"
              }`}
            >
              {/* Icon */}
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-red-600/10 border border-red-600/40 flex-shrink-0">
                {item.icon}
              </div>
              ...
              <div className="flex-1">
                <h3
                  className={`text-lg md:text-xl font-semibold mb-1 transition-colors ${
                    currentIndex === index ? "text-red-600" : "text-white"
                  }`}
                >
                  {item.title}
                </h3>
              ...
              {/* Step Number */}
              <div className="hidden md:block text-2xl font-bold text-red-600/40">
